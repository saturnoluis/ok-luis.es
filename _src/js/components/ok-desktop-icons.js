...
class OkDesktopIcons extends LitElement {
	...
	render() {
		return html`
			<div class="inner">
				<a href="/desktop" class="desktop-icon" title="About me">
					<img src="/static/img/icon-about-me.png" alt="About me" />
					<span>About me</span>
				</a>
				<a href="/articles" class="desktop-icon" title="Articles">
					<img src="/static/img/icon-articles.png" alt="Articles" />
					<span>Articles</span>
				</a>
				<a href="/my-links" class="desktop-icon" title="My Links">
					<img src="/static/img/icon-my-links.png" alt="My Links" />
					<span>My Links</span>
				</a>
			</div>
		`;
